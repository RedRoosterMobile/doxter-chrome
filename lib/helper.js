...
function getSettings() {
  ...
  window.api_base_url = localStorage.getItem("doxter-api-base-url") ? localStorage.getItem("doxter-api-base-url") : "http://www.doxter.de/api/v1";
...
function notifyUser(text, image_) {
  var title = "doxter Chrome";
